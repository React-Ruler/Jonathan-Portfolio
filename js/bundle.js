  ...
  \**************************************************/
          ...
          return {
            ...
            getEmployee: function getEmployee() {
              ...
              if (employeeId != null || employeeId != undefined) {
                (0, _api["default"])()
                  .get("/employees/".concat(employeeId))
    ...
    34: [
      function (require, module, exports) {
        ...
        var url =
          "https://whispering-castle-04462.herokuapp.com/https://ninja-json-server.herokuapp.com/employees";
                ...
                if (data.length > 0) {
                  data.forEach(function (value, index) {
                    if (
                      ...
                      var template =
                        '\n                        <a class="search-result" href="employee.html?id='
                          .concat(
                            value.id,
      ...
      function (require, module, exports) {
        ...
        function getBaseAPI() {
          return _axios["default"].create({
            ...
            baseURL:
              "https://whispering-castle-04462.herokuapp.com/https://ninja-json-server.herokuapp.com",
          });
        }
      },
      { axios: 3 },
    ...
    40: [
      ...
      {
        "./libs/components/employee": 32,
        "./libs/components/employees": 33,
        "./libs/components/navbar": 34,
        "./libs/components/pageloader": 35,
        "./libs/components/posts": 36,
        "./store/store": 41,
        alpinejs: 2,
        "feather-icons": 30,
      },
